        ...
        <div class="flex flex-col md:flex-row md:min-h-screen w-full">
            ...
            <div @click.away="open = false" x-data="{ open: false }" class="flex flex-col w-full md:w-64 text-gray-700 bg-white dark-mode:text-gray-200 dark-mode:bg-gray-800 flex-shrink-0">
              ...
              <nav :class="{'block': open, 'hidden': !open}" class="flex-grow md:block px-4 pb-4 md:pb-0 md:overflow-y-auto">
                ...
                <a class="block px-4 py-2 mt-2 text-sm font-semibold text-gray-500 bg-transparent rounded-lg hover:text-gray-600 focus:outline-none focus:shadow-outline" href="{{ Route('reserves') }}"><i class="fa-solid fa-cart-shopping cursor-pointer mr-2 block lg:hidden"></i>Reservas</a>
                ...
                <a class="block px-4 py-2 mt-2 text-sm font-semibold text-gray-500 bg-transparent rounded-lg hover:text-gray-600 focus:outline-none focus:shadow-outline" href="{{ Route('reviews') }}"><i class="fa-solid fa-star cursor-pointer mr-2 block lg:hidden"></i>Avaliações</a>
                ...
                @if (auth()->user()->role == "Dono")
                  ...
                  <a class="block px-4 py-2 mt-2 text-sm font-semibold text-gray-500 bg-transparent rounded-lg hover:text-gray-600 focus:outline-none focus:shadow-outline" href="{{ Route('business') }}"><i class="fa-solid fa-business-time cursor-pointer mr-2 block lg:hidden"></i>Empresa</a>
