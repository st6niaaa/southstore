                       ...
                       <div class="sm:col-span-2">
                           ...
                           <div class="mt-2">
                               <div class="flex items-center space-x-2">
                                   ...
                                   <input wire:model="price" type="number" placeholder="5.650" min="0" name="price" id="price" class="block w-full max-w-xs px-3 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 sm:text-sm sm:leading-6">
                               </div>
                           </div>
                       </div>
                   </div>
