<div class="font-family p-2">
    <div class="flex justify-between items-center mb-2">
        ...
        @if (auth()->user()->role == "Dono") <a href="{{ route('admin.products.create')}}"><button class="text-sm bg-blue-600 border border-blue-600 hover:bg-blue-700 text-white py-1 px-3 rounded-md">Novo Produto</button></a> @endif
    </div>
