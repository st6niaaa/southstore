<div class="font-family p-2">
    <h1 class="text-2xl font-bold text-blue-700 mb-3">Adicionar Visualização 3D</h1>
    <div class="bg-white h-full p-3 rounded-lg flex flex-col sm:flex-row">
        <div class="relative w-full">
            ...
            <div class="px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
              ...
              <button wire:click="remove3DView" type="button" class="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto">Remover 3D</button>
            </div>
        </form>
          </div>
    </div>
