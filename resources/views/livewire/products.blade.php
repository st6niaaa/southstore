        ...
        <div class="container px-6 py-8 mx-auto">
            <div class="lg:flex lg:-mx-2">
                <div class="space-y-3 lg:w-1/5 lg:px-2 lg:space-y-4">
                    <a href="#" class="font-family block font-medium text-gray-500 hover:text-blue-600">iPads</a>
                    <a href="#" class="font-family block font-medium text-gray-500 hover:text-blue-600">Macbooks</a>
                    <a href="#" class="font-family block font-medium text-blue-600 hover:text-blue-600">iPhones</a>
                    <a href="#" class="font-family block font-medium text-gray-500 hover:text-blue-600">Outros Produtos</a>
                </div>
                    ...
                    <div class="mb-4 mt-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
                        ...
                        <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                          <div class="h-56 w-full">
                            <a href="#">
                              <img class="mx-auto h-full" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/iphone-light.svg" alt="" />
                          ...
                          <div class="pt-6">
                            ...
                            <a href="#" class="font-family text-lg font-semibold leading-tight text-gray-900 hover:underline">Apple iPhone 15 Pro Max</a>
                            ...
                            <div class="mt-2 flex items-center gap-2">
                              ...
                              <p class="text-sm font-medium text-gray-500">(1,233)</p>
                            </div>
                            ...
                            <div class="mt-4 flex items-center justify-between gap-4">
                              <p class="font-family text-2xl font-extrabold leading-tight text-gray-900">R$5,500</p>
                        ...
                        </div>    <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                            <div class="h-56 w-full">
                              <a href="#">
                                <img class="mx-auto h-full" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/iphone-light.svg" alt="" />
                                <img class="mx-auto hidden h-full" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/iphone-dark.svg" alt="" />
